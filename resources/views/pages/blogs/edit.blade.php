                        ...
                        <form action="{{ route('blog.update', $blog->id) }}" method="POST" class="ml-4">
                            ...
                            <div class="w-full sm:w-auto order-last sm:order-first">
                                ...
                                <div class="md:flex md:items-center mb-4">
                                    ...
                                    <div class="md:w-3/3">
                                        <input name="content" class="form-control bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" type="date" placeholder="{{$blog->content}}">
                                        @error('content')
                                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                        @enderror
                                    </div>
